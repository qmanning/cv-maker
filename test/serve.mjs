...
// /index.html). Zero dependencies. Model: Infospector's test/serve.mjs.
...
const port = Number(process.argv[2] || process.env.PORT || 7333);
...
}).listen(port, '127.0.0.1', () => console.log(`cv-maker: http://localhost:${port}/`));
