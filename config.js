// config.js — optional defaults for IcedCoffee. Loaded as a classic script before dist/icedcoffee.js, so
// it just needs to set window.ICEDCOFFEE before that module runs. Every value is optional; uncomment
