...
- **Duplicate, move, and delete repeatable entries** — click into any `[data-cv-repeat]` block (a job, say) and a small tool pill appears beside it: move up, move down, duplicate, delete.
