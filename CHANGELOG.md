...
- **Desktop: a welcome sheet** on first launch (and under **Help ▸ Welcome to CV Maker**): five lines on how the editor works, then *Start with the sample* or *Open a résumé file…*. The macOS installer window now carries the first-launch steps and a shortcut straight to **Privacy & Security**.
