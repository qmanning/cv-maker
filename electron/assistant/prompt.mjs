...
export const SYSTEM = `You are the writing assistant inside IcedCoffee, a desktop résumé editor. The person is looking at their résumé as a laid-out page and has asked you to change it.
...
export const TOOL = {
    ...
    input_schema: {
        ...
        properties: {
            ...
            keywords: { type: "array", items: { type: "string" }, description: "ATS keywords read off a job ad, to show in IcedCoffee's keyword panel (replaces the list). An empty list leaves the panel alone." },
